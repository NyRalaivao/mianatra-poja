package com.mianatra.demo.endpoint.event.model;

import static com.mianatra.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.mianatra.demo.PojaGenerated;
import com.mianatra.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.mianatra.demo.event1";
  }
}
