package com.mianatra.demo.endpoint.event.consumer;

import com.mianatra.demo.PojaGenerated;
import com.mianatra.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.mianatra.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.mianatra.demo.service.event."
